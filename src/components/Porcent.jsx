  ...
  return (
    ...
    >
      <div className="cuadros relative flex flex-wrap content-start p-[0_16px] md:p-[0_32px] lg:p-[0_48px] w-full">
        <div className="vacio relative w-full lg:h-[2vh] xl:h-[5vh]"></div>
        <div className="cont-txt p-[15px_0] xl:p-0">
          <img
            className="mb-[10px] ml-[15px] max-h-[40px] md:max-h-[50px]"
            src={imagen}
            alt={alt}
          />
          <div className="text flex relative w-full">
            <h2 className="txt text-white relative font-bold text-[25px] md:text-[40px]">
              {numero}
            </h2>
            <span className="porc text-white text-[25px] md:text-[35px] font-bold">%</span>
          </div>
